  ...
  const  EnhancedTableBooks: React.FC = (props:any) =>  {
    ...
    function handleSelectAllClick(event: React.ChangeEvent<HTMLInputElement>) {
      if (event.target.checked) {
        const newSelecteds = books.map((n:any) => n.body.title);
              ...
              >
                ...
                <TableBody>
                  ...
                  {stableSort(books, getSorting(order, orderBy))
                    ...
                    .map((row:any, index) => {
                      const isItemSelected = isSelected(row.body.title);
                      ...
                      return (
                        <TableRow
                          ...
                          tabIndex={-1}
                          key={row.body.title+row.id}
                          selected={isItemSelected}
                        >
                          <TableCell padding="checkbox">
                            <Checkbox
                              onClick={event => handleClick(event, row.body.title)}
                          ...
                          <TableCell align="right">{row.body.amount}</TableCell>
                          <TableCell align="right">{row.body.price}</TableCell>
                          <TableCell align="right">
                            <TransitionsModalEdit
                              imgId={row._id}
                              bookId={row._id}
                              bookTitle={row.body.title}
                              bookImage={row.body.img}
                              bookDescription={row.body.description}
                              bookPrice={row.body.price}
                              bookAmount={row.body.amount}
                            />
                          </TableCell>
